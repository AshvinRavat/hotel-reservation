    ...
    */
    ...
    'custom' => [
        'first_name' => [
            ...
            'max' => 'First name should not grates than 50 character',
            'string' => 'First name must be string only',
            'regex' => 'First name must be string characters only',
        ],
        'last_name' => [
            'required' => 'Last name is required',
            'max' => 'Last name should not grates than 50 character',
            'string' => 'Last name must be string only',
            'regex' => 'Last name must be string characters only',
        ],
        'email' => [
            'required' => 'Email is required',
            'max' => 'Email should not grates than 255 characters',
        ],
        'profile' => [
